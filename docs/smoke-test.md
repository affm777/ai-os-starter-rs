...
Erwarteter Output: `Cloning into 'ai-os-starter-rs'...` ohne Fehler.
...
[ -d ~/.claude/rules ] && [ "$(ls ~/.claude/rules | wc -l | tr -d ' ')" = "2" ] && echo "rules OK (2 Files)" || echo "FAIL: rules nicht korrekt"
[ -d ~/.claude/commands/brain ] && [ "$(ls ~/.claude/commands/brain | wc -l | tr -d ' ')" = "4" ] && echo "brain-commands OK (4 Files)" || echo "FAIL: brain-commands nicht korrekt"
[ -f ~/.claude/templates/new-project/CLAUDE.md.template ] && echo "new-project-Templates OK" || echo "FAIL: new-project-Templates fehlen"
[ -f ~/Documents/Second-Brain/00_Meta/clusters/vault-clusters.md ] && echo "vault-clusters OK" || echo "FAIL: vault-clusters.md fehlt"
